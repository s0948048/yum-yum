...
$('#step-plus').on('click', function () {
    ...
    if (steps == 1) {
        ...
        $(`#step-countdiv0${steps - 1}`).removeClass('mb-200')
        //中間連線
        $('#right-steps').append('<div b-mc3u0u1te1 style="position: absolute;margin-top: 50.2rem;margin-left:-26px;color:var(--yum-secondary-4)"><img b-mc3u0u1te1 class="remove-steps" style="width:50px;height:50px" src="/img/icon/close.svg" />─────────────</div>')
        //步驟本人
        $('#right-steps').append(stepRight);
        //計數
        $('#right-steps').append(`<div b-mc3u0u1te1 class="d-flex mb-200" id="step-countdiv0${steps}" style="margin-right:146px"><label b-mc3u0u1te1 id ="step-count0${steps}" class= "d-flex ms-auto">0/100</label></div>`);
        //新增計數邏輯
        ...
        $(`#step-countdiv0${steps - 1}`).removeClass('mb-200')
        //中間連線
        $('#left-steps').append('<div b-mc3u0u1te1 style="position: absolute;margin-top: 50.2rem;margin-left: 24.7rem;color:var(--yum-secondary-4)"> ─────────────<img b-mc3u0u1te1 class="remove-steps" style="width:50px;height:50px" src="/img/icon/close.svg"/></div>')
        //步驟本人
        $('#left-steps').append(stepLeft);
        //計數
        $('#left-steps').append(`<div id="step-countdiv0${steps}" class="d-flex mb-200" style="margin-right: 260px"><label id ="step-count0${steps}" class="d-flex ms-auto">0/100</label></div>`);
